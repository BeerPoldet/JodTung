...
public extension JTAppleCalendarViewDelegate {
    ...
    func calendarWillBeginDragging(_ calendar: JTAppleCalendarView) {
        
    }
    
    func calendarWillEndDragging(_ calendar: JTAppleCalendarView) {
        
    }
    
    func calendarDidEndScrollingAnimation(_ calendar: JTAppleCalendarView) {
        
    }
    
    func calendarDidEndDecelerating(_ calendar: JTAppleCalendarView) {
