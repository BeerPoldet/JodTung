...
extension JTAppleCalendarView: UIScrollViewDelegate {
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        self.delegate?.calendarDidScroll(self)
    }
    ...
    public func scrollViewWillBeginDragging(_ scrollView: UIScrollView) {
        self.delegate?.calendarWillBeginDragging(self)
    }
    ...
    public func scrollViewWillEndDragging(_ scrollView: UIScrollView,
        ...
        targetContentOffset: UnsafeMutablePointer<CGPoint>) {
            ...
            self.delegate?.calendarWillEndDragging(self)
    ...
    public func scrollViewDidEndScrollingAnimation(
        _ scrollView: UIScrollView) {
            ...
            self.delegate?.calendarDidEndScrollingAnimation(self)
    }
    ...
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        self.delegate?.calendarDidEndDecelerating(self)
    }
