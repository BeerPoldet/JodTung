...
open class JTAppleCalendarView: UIView {
  ...
  open var scrollsToTop: Bool = true {
    didSet {
      calendarView.scrollsToTop = scrollsToTop
    }
  }
  
  open var contentInset: UIEdgeInsets = UIEdgeInsets.zero {
    didSet {
      calendarView.contentInset = contentInset
    }
  }
    ...
    lazy var calendarView: UICollectionView = {
        ...
        let cv: UICollectionView = UICollectionView(frame: CGRect.zero,
        ...
        cv.scrollsToTop = self.scrollsToTop
        cv.contentInset = self.contentInset
        #if os(iOS)
